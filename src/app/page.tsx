...
export default function Home() {
  ...
  return (
    ...
    >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-[#0f152d] border-4 border-red-500 rounded-2xl p-6 max-w-sm w-full text-center shadow-2xl animate-fade-in">
            ...
            <p className="text-xs text-gray-300 mb-6 leading-relaxed">
              Sei sicuro di voler abbandonare? Tutti i progressi di questa run andranno persi per sempre!
            </p>
      ...
      {/* HEADER */}
      <header className={`text-center border-b-4 border-[#ff9f1c] w-full max-w-6xl shrink-0 ${isRunActive ? "mb-2 pb-1" : "mb-6 pb-4"}`}>
        ...
        {!isRunActive && (
          <p className="text-gray-400 mt-2 text-sm md:text-base tracking-wide">
            Un'avventura tattica roguelike a turni ispirata alle saghe dei ninja.
          </p>
        )}
      </header>
        ...
        !activeSagaId ? (
          ...
          <div className="max-w-4xl w-full space-y-8 animate-fade-in py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                {/* Status Badge */}
                <span className="absolute top-3 right-3 bg-green-500/20 text-green-400 text-xs px-2 py-0.5 rounded font-bold shadow-md z-10 border border-green-500/30">ATTIVO</span>

                {/* Description and button below */}
                <div className="p-5 bg-gradient-to-t from-gray-950 via-gray-950/90 to-transparent pt-16">
                  <h3 className="text-2xl font-bold text-[#ff9f1c] mb-2 drop-shadow-md">Naruto Classico (Bambini)</h3>
                  <p className="text-gray-300 text-sm leading-relaxed mb-4 drop-shadow">
                    Rivivi le origini del Team 7! Affronterai la Prova dei Campanelli, il Paese delle Onde,
                    l'esame di selezione dei Chunin, l'Invasione della Foglia e lo Scontro alla Valle della Fine.
                  </p>
              ...
              {isShippudenUnlocked ? (
                ...
                >
                  {/* Status Badge */}
                  <span className="absolute top-3 right-3 bg-green-500/20 text-green-400 text-xs px-2 py-0.5 rounded font-bold shadow-md z-10 border border-green-500/30">SBLOCCATO</span>

                  {/* Description and button below */}
                  <div className="p-5 bg-gradient-to-t from-gray-950 via-gray-950/90 to-transparent pt-16">
                    <h3 className="text-2xl font-bold text-[#ff9f1c] mb-2 drop-shadow-md">Naruto Shippuden</h3>
                    <p className="text-gray-300 text-sm leading-relaxed mb-4 drop-shadow">
                      Il ritorno dei ninja cresciuti! Guida il Team 7 contro Itachi, Jiraiya e Orochimaru per dominare il chakra supremo della volpe.
                    </p>
                    <button className="w-full py-3 bg-[#ff9f1c] hover:bg-yellow-500 text-[#070b19] font-bold rounded-lg uppercase tracking-wider text-sm transition-all border-b-4 border-amber-700">
                      Inizia Shippuden
                    </button>
                ...
                >
                  {/* Status Badge */}
                  <span className="absolute top-3 right-3 bg-red-500/20 text-red-400 text-xs px-2 py-0.5 rounded font-bold shadow-md z-10 border border-red-500/30">BLOCCATO</span>

                  <div className="p-5 bg-gradient-to-t from-gray-950 via-gray-950/90 to-transparent pt-16">
                    <h3 className="text-2xl font-bold text-gray-500 mb-2 drop-shadow-md">Naruto Shippuden</h3>
                    <p className="text-gray-500 text-sm leading-relaxed mb-4 drop-shadow">
                      Il ritorno di Naruto dopo l'allenamento con Jiraiya. Sconfiggi Gaara nella saga classica dei bambini per sbloccare questa modalità.
                    </p>
                    <button disabled className="w-full py-3 bg-gray-850 text-gray-600 font-bold rounded-lg uppercase tracking-wider text-sm">
                      🔒 Sconfiggi Gaara per sbloccare
                    </button>
                  </div>
                </div>
              )}
          ...
          <div className="max-w-5xl w-full space-y-8 animate-fade-in text-center py-8">
            <div>
              ...
              <div className="text-xs text-gray-400 uppercase tracking-widest font-mono float-right mt-2">
                Saga Attiva: {activeSagaId === "classic_naruto" ? "Naruto Bambini" : "Naruto Shippuden"}
              </div>
              <div className="clear-both"></div>
            </div>

            <h2 className="text-3xl font-extrabold text-[#ff9f1c] uppercase tracking-wider">SCEGLI IL TUO NINJA DI PARTENZA</h2>
            <p className="text-gray-400 max-w-xl mx-auto text-sm">
              Per questa avventura avrai a disposizione un team che si espanderà fino a 6 membri. Scegli ora il tuo ninja iniziale tra queste 3 scelte casuali:
            </p>
              ...
              {startingChoices?.map((ninja) => (
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    />
                    <h3 className="text-2xl font-bold text-[#ff9f1c] mb-1">{ninja.name}</h3>
              ...
              {runTeam.map((ninja) => {
                ...
                return (
                  <div
                    ...
                    className={`p-3 bg-[#070b19] rounded-xl border-2 transition-all ${
                      isDefeated 
                  ...
                  >
                    <div className="flex gap-2 items-center mb-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-sm font-bold truncate">{ninja.name}</div>
                        <div className="text-[9px] text-[#ff9f1c] uppercase tracking-widest font-mono flex items-center justify-between">
                          ...
                          {pendingJutsuToLearn && (
                            isMax ? (
                              <span className="text-red-400 font-extrabold text-[8px]">MAX TECH</span>
                            ) : (
                              <span className="text-green-400 font-extrabold text-[8px] animate-pulse">⚡ USA ROTOLO</span>
                            )
                          )}
                        </div>
                      </div>
          ...
          <div className="lg:col-span-2 flex flex-col items-center h-full min-h-0 relative w-full">
            ...
            <div className="flex-1 w-full max-w-[650px] bg-[#3a5a40] border-4 border-[#ff9f1c] rounded-2xl relative overflow-hidden shadow-2xl flex flex-col min-h-0">
              ...
              {activeMap.map((node) => {
                ...
                let iconSymbol = "⚔️";
                let customLabel = "Battaglia";
                if (node.type === "powerup") {
                  iconSymbol = "📜";
                  customLabel = "Rotolo Proibito";
                } else if (node.type === "recruit") {
                  iconSymbol = "🏫";
                  customLabel = "Reclutamento";
                } else if (node.type === "heal") {
                  iconSymbol = "🍜";
                  customLabel = "Ramen Ichiraku";
                } else if (node.type === "boss") {
                  iconSymbol = "👹";
                  customLabel = "Scontro Boss";
                }
                ...
                return (
                  <div
                    ...
                    title={isReachable ? customLabel : `${customLabel} (Non Raggiungibile)`}
                  >
                    {node.type === "powerup" && (
                      <img
                ...
                <div className="absolute inset-0 bg-black/85 z-30 flex items-center justify-center p-5 text-center animate-fade-in">
                  <div className="bg-green-950/40 border-4 border-green-500 rounded-2xl p-6 shadow-2xl max-w-sm w-full animate-pulse">
                    <h3 className="text-xl font-bold text-green-400 mb-2 uppercase tracking-wider">
                      ROTOLO PROIBITO ATTIVO ⚡
                    </h3>
                    <p className="text-sm text-gray-255 leading-relaxed">
                      Seleziona il ninja direttamente dalla tua **squadra a sinistra** per potenziarne la mossa ed avanzare.
                    </p>
                  </div>
                </div>
              )}
                    ...
                    {pendingRecruitId ? (
                      <div>
                        ...
                        <p className="text-[11px] text-gray-400 mb-4">
                          Squadra al completo (6/6). Seleziona chi congedare per far posto al nuovo ninja.
                        </p>
                          ...
                          {runTeam.map((ninja) => (
                            ...
                            >
                              <div className="flex gap-2.5 items-center">
                                 ...
                                 />
                                <div>
                                  <h4 className="font-bold text-gray-200 text-xs truncate">{ninja.name}</h4>
                                  <p className="text-[9px] text-gray-400">Lv. {ninja.level}</p>
                                </div>
                              </div>
                              <span className="text-red-400 font-bold text-xs uppercase tracking-wider hover:text-red-300">Congeda</span>
                            </button>
                          ))}
                        </div>
                        <button
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-green-400 mb-1 uppercase tracking-wider">
                          RECLUTA UN NUOVO NINJA
                        </h3>
                        <p className="text-[11px] text-gray-400 mb-4">
                          Scegli 1 ninja da aggiungere alla tua squadra (livello {runTeam[0]?.level || 5}).
                        </p>
                        <div className="grid grid-cols-3 gap-3">
                          {availableRecruitChoices.map((ninja) => (
                            ...
                            >
                              ...
                              />
                              <h4 className="font-bold text-green-400 text-[10px] truncate mb-1">{ninja.name}</h4>
                ...
                <div className="absolute inset-0 bg-black/85 z-30 flex items-center justify-center p-5 animate-fade-in">
                  <div className="bg-[#0f152d] border-4 border-green-500 rounded-2xl p-6 shadow-2xl w-full max-w-sm text-center">
                    ...
                    <p className="text-xs text-gray-300 mb-5 leading-relaxed">
                      Un momento di sosta al Ramen Ichiraku rigenera completamente HP e Chakra di tutti i membri della tua squadra.
                    </p>
                    <button
            ...
            <div className="flex-1 min-h-0 flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto pr-1">
                {activePowerUps.length > 0 ? (
                        ...
                        >
                          {targetNinja && (
                            <img
                              ...
                              alt={targetNinja.name}
                              className="w-12 h-12 object-contain bg-gray-900 rounded-lg p-1 border border-gray-800 shrink-0"
                            />
                          )}
                          <div className="min-w-0 flex-1">
                            <div className="font-bold text-green-400 truncate text-sm">{p.name}</div>
                            <p className="text-xs text-gray-400 font-semibold truncate leading-normal">{targetNinja ? targetNinja.name : "Squadra"}</p>
                            {oldJutsu && newJutsu && (
                              <div className="text-[10px] text-gray-500 leading-none flex items-center gap-1 mt-0.5">
                                <span className="line-through truncate max-w-[85px] cursor-help" title={`Mossa Precedente: ${oldJutsu.name}`}>{oldJutsu.name}</span>
                                <span className="text-gray-650">→</span>
                                <span className="text-green-300 font-bold truncate max-w-[95px] cursor-help" title={`Mossa Potenziata: ${newJutsu.name}`}>{newJutsu.name}</span>
                              </div>
                            )}
                          </div>
                        </div>
                  ...
                  <p className="text-xs text-gray-550 italic">Nessun potenziamento attivo</p>
                )}
              </div>
            </div>
                        ...
                        return (
                          <div key={boss.id} className="flex flex-col items-center gap-1">
                            <div
                              ...
                              title={isDefeated ? `Sconfitto: ${boss.name}` : `Boss da sconfiggere: ${boss.name}`}
                            >
                              {isDefeated ? (
                                <img
                                  ...
                                  alt={boss.name}
                                  className="w-full h-full object-cover rounded-full absolute inset-0 bg-gray-955 p-0.5"
                                />
                              ) : (
                                <span className="text-xs font-mono font-bold">?</span>
                              )}
                            </div>
                            <span className="text-[7px] text-gray-400 truncate max-w-[44px] text-center font-semibold">{boss.name}</span>
                          </div>
                        );
                      })}
                    </div>
